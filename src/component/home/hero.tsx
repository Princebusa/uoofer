     ...
     >
      ...
      <div className="max-section relative block z-10">
        <div className="my-[150px] flex flex-col gap-7 items-center relative">
           ...
           <p className="pr-[15px] pl-[8px] py-[2px] font-[400] text-[13px] border-[#ffffff4d] border rounded-full backdrop-blur-[5px] bg-[#ffffff52] flex items-center gap-2"><img width={"20px"} src="/src/assets/ai.png" alt="ai" />Ai Automation</p>
